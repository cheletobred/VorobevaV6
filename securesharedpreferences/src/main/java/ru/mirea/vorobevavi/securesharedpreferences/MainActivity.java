package ru.mirea.vorobevavi.securesharedpreferences;
...
import ru.mirea.vorobevavi.securesharedpreferences.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            secureSharedPreferences.edit().putString("secure", "Эрих Мария Ремарк").apply();
